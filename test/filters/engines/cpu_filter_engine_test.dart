...
void main() {
  ...
  test('Mosaic keeps output dimensions', () async {
    const registry = DefaultFilterRegistry();
    final preset = registry.getById(mosaicFilterId)!;
  ...
  test('Neon Heat produces a valid JPEG output file', () async {
    const registry = DefaultFilterRegistry();
    final preset = registry.getById(neonHeatFilterId)!;
