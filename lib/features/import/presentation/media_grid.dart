...
class MediaGrid extends StatelessWidget {
  const MediaGrid({
    ...
    this.selectionOrderByAssetId = const {},
    super.key,
  });
  ...
  final Map<String, int> selectionOrderByAssetId;
      ...
      itemBuilder: (context, index) {
        ...
        return ClipRRect(
          ...
          child: MediaGridTile(
            ...
            isSelected: selectedAssetIds.contains(assets[index].id),
            selectionIndex: selectionOrderByAssetId[assets[index].id],
          ),
        );
      },
    );
