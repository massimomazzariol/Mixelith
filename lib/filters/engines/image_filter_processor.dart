...
ProcessedFilterImage _processFilterImageInBackground(
  ...
  final output = switch (presetId) {
    ...
    neonHeatFilterId => _neonHeat(resized.image, parameters),
    popPosterFilterId => _popPoster(resized.image, parameters),
    watercolorFilterId => _watercolor(resized.image, parameters),
    mosaicFilterId => _mosaic(resized.image, parameters),
...
img.Image _neonHeat(img.Image source, Map<String, double> parameters) {
...
img.Image _watercolor(img.Image source, Map<String, double> parameters) {
  final intensity = parameters['intensity'] ?? 1.0;
...
img.Image _mosaic(img.Image source, Map<String, double> parameters) {
...
img.Image _popPoster(img.Image source, Map<String, double> parameters) {
